...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["dashboard-dashboard-module"], {
  ...
  function srcAppDashboardDashboardModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_material_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    ...
    DashboardModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_home_home_component__WEBPACK_IMPORTED_MODULE_4__["HomeComponent"], _employeedetails_employeedetails_component__WEBPACK_IMPORTED_MODULE_5__["EmployeedetailsComponent"], _addemployee_addemployee_component__WEBPACK_IMPORTED_MODULE_6__["AddemployeeComponent"], _update_employee_update_employee_component__WEBPACK_IMPORTED_MODULE_8__["UpdateEmployeeComponent"], _header_header_component__WEBPACK_IMPORTED_MODULE_12__["HeaderComponent"], _filter_pipe__WEBPACK_IMPORTED_MODULE_7__["FilterPipe"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _dashboard_routing_module__WEBPACK_IMPORTED_MODULE_3__["DashboardRoutingModule"], ngx_pagination__WEBPACK_IMPORTED_MODULE_10__["NgxPaginationModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_11__["FormsModule"], _shared_material_module__WEBPACK_IMPORTED_MODULE_9__["MaterialModule"]]
    })], DashboardModule);
    /***/
  },
  ...
  function srcAppEmployeedetailsEmployeedetailsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _admin_service_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../admin-service.service */
    "./src/app/admin-service.service.ts");
    ...
    var EmployeedetailsComponent = /*#__PURE__*/function () {
      function EmployeedetailsComponent(route, service, modalservice) {
        ...
        this.route = route;
        this.service = service;
        this.modalservice = modalservice; // myid : number;
      ...
      _createClass(EmployeedetailsComponent, [{
        ...
        value: function GetDataFromUrl() {
          ...
          this.route.paramMap.subscribe(function (param) {
            ...
            _this3.GetDataFromBackend(param.get("employeeId"));
          });
        }
      }, {
        key: "GetDataFromBackend",
        value: function GetDataFromBackend(employeeId) {
          var _this4 = this;

          this.service.getEmployeeById(employeeId).subscribe(function (response) {
            console.log(response);
        ...
        value: function onDelete() {
          ...
          if (this.radioCheck()) {
            this.dialogservice.OpenConfirmDialog('Are you sure to delete this record?').afterClosed().subscribe(function (res) {
              ...
              if (res) {
                //Delete a record
                _this6.service.deleteRecord(_this6.empobj.employeeID).subscribe(function (response) {
                  // console.log(response)
                  _this6.toaster.success(response);

                  _this6.getDataFromBackend();
                });
              }
            });
          } else {
  ...
  function srcAppUpdateEmployeeUpdateEmployeeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var UpdateEmployeeComponent = /*#__PURE__*/function () {
      function UpdateEmployeeComponent(service, toaster) {
      ...
      _createClass(UpdateEmployeeComponent, [{
        ...
        value: function onupdate() {
          ...
          this.service.UpdateEmployee(this.parentdata).subscribe(function (response) {
            ...
            _this9.toaster.success(response);
          });
        }
      }]);

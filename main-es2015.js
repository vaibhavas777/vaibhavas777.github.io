...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- <app-admin-login></app-admin-login> -->\n\n<router-outlet></router-outlet>");
...
let AdminLoginComponent = class AdminLoginComponent {
    ...
    onSubmit(f) {
        ...
        this.service.login(obj)
            ...
            if (this.loginObj.message == "Invalid user !!") {
                this.incorrect = this.loginObj.message;
            }
            else {
                sessionStorage.setItem('employeeName', this.loginObj.empobj.employeeName);
                sessionStorage.setItem('employeeID', this.loginObj.empobj.employeeID);
                sessionStorage.setItem('role', this.loginObj.empobj.role);
...
let AdminServiceService = class AdminServiceService {
    ...
    getEmployeeById(employeeId) {
        return (this.http.get(`${this.BaseUrl}admin/getEmployee/${employeeId}`));
    }
    getAllCountries() {
        return (this.http.get(`${this.BaseUrl}country/getAllCountries`));
    }
    AddEmployee(obj) {
        return (this.http.post(`${this.BaseUrl}admin/saveEmployee`, obj));
    }
    UpdateEmployee(obj) {
        return (this.http.put(`${this.BaseUrl}admin/updateEmployee`, obj, { responseType: 'text' }));
    }
    deleteRecord(id) {
        return (this.http.delete(`${this.BaseUrl}admin/deleteEmployee/${id}`, { responseType: 'text' }));
    }
    updateStatus(obj) {
        return (this.http.put(`${this.BaseUrl}admin/updateStatus`, obj, { responseType: 'text' }));
    }
    forgetPassword(email) {
        return (this.http.get(`${this.BaseUrl}admin/forgetPassword/${email}`, { responseType: 'text' }));
    }
};
...
//if String return from backend = ,{responseType:'text'}
...
/* harmony import */ var _forget_password_forget_password_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./forget-password/forget-password.component */ "./src/app/forget-password/forget-password.component.ts");
...
const routes = [
    ...
    {
        path: "forgetpassword", component: _forget_password_forget_password_component__WEBPACK_IMPORTED_MODULE_4__["ForgetPasswordComponent"]
    },
    {
...
/* harmony import */ var angular_particle__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! angular-particle */ "./node_modules/angular-particle/index.js");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _admin_login_admin_login_component__WEBPACK_IMPORTED_MODULE_5__["AdminLoginComponent"],
        ...
        imports: [
            ...
            angular_particle__WEBPACK_IMPORTED_MODULE_12__["ParticlesModule"],
...
let ForgetPasswordComponent = class ForgetPasswordComponent {
    ...
    onSubmit(email) {
        ...
        this.service.forgetPassword(email.value.email)
            .subscribe((response) => {
            this.toaster.success(response.toString());
        });
    }
    ngOnDestroy() {
        document.body.className = '';
...
ForgetPasswordComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./forget-password.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/forget-password/forget-password.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./forget-password.component.css */ "./src/app/forget-password/forget-password.component.css")).default]
    })
...
/* harmony import */ var _mat_confirm_dialog_mat_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./mat-confirm-dialog/mat-confirm-dialog.component */ "./src/app/shared/mat-confirm-dialog/mat-confirm-dialog.component.ts");
...
module.exports = __webpack_require__(/*! E:\Front end\Angular\angualr-project\src\main.ts */"./src/main.ts");
